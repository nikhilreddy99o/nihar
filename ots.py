...
def switch_to_repository():
    repository_url = input("Enter the URL of the repository to switch to: ")
    os.system(f"git remote set-url origin {repository_url}")
...
while True:
    ...
    if user_choice == "1":
        ...
        switch_option = input(f"{ORANGE}Do you want to switch? (1: Branch, 2: Repository, 0: No) {NC}")
        if switch_option == "1":
            switch_to_branch()
